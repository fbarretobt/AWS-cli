...
def convert_csv(items_dict):
    file_name = "list.csv"
    header = "Name, Snapshots, Region, Days Old, Since Last snapshot in Hrs, Mount Point , Encryption"
    ...
    for item in items_dict.values():
        ...
        line = "\n" + item["Name"] + "," + str(item['Snapshots']) +"," + item["Region"] + "," + str(item["Days Old"]) + "," + str(item["Hours Old"]) + "," + devicename + ","+ str(item["Encryption"])
        #print(line)
